...
class player {
  username: string;
  private original_health: number = 100;
  public current_health:number = this.original_health
  money: number = 100;
  attack_max: number = 40;
  attack_min: number = 20;
  attack_percentage: number = 0;
  constructor(name: string) {
    this.username = name;
  }
  healthdecrease(monster_attack_damage: number) {
    let health: number;
  ...
  healthheal(health_percent:number):number
  {
...
class opponent {
  ...
  attack_min: number = 0;
  attack_percentage: number = 0;
  healthdecrease(Player_attack_damage: number) {
    let health: number;
...
function removeByFilter(arr: any[], selection: any): any[] {
...
while (start_tab) {
  ...
  if (opt === "Start Adventure") {
    ...
    while (further_go) {//this loop will continue if user win and say yes to continue more fight in same rank 
      ...
      ══════════════════•°• ⚠  ${Rank_level}  ⚠ •°•══════════════════
      \t\t\t${chalk.bold.greenBright(userdata.username)} HP: ${chalk.bold.yellow(
        userdata.current_health
      )}
             \t\t\tVS
      \t\t\t${chalk.bold.magenta(monster.m_name)} HP: ${chalk.bold.yellow(
        monster.health
      )}
      ═══════════════════════•°• ⚠ •°•═══════════════════════
      `));
      ...
      while (fighting) {
        ...
        if (fight_option.opt === "Attack to Monster") {//if player select attack to monster 
          ...
          if (user_attack === 1 && oppenent_attack === 0) {//1 mean player attacked to mosnter and zero mean player counld'nt attack to monster
            ...
            Player_attack_damage = Math.floor(
            ...
            console.log(`
              ${chalk.bold.magenta(
                `»»—————————————————————- ${userdata.username} vs ${monster.m_name} —————————————————————-««`
              )}
              ...
              monster.health
            )} got Damage :${chalk.bold.yellowBright(Player_attack_damage)}

                   \t\t   ${chalk.bold.greenBright(
                     `!! You dodged opponent attack !!`
                   )}
            ...
            monster_attack_damage = Math.floor(
            ...
            console.log(`
              ...
              userdata.current_health
            )} got Damage :${chalk.bold.redBright(monster_attack_damage)}
  ...
  ${chalk.yellowBright(`
        ...
        },
        {
          ...
          ╔═══━━━───━━━───━━━───━━━───━━━───━━━───━━━─── • ───━━━───━━━───━━━───━━━───━━━───━━━───━━━━═══╗
                      ...
                      \t\t${chalk.bold.bgGrey(
                    `!!    Category Shields and Armors (Shop)   !!`
                        )}
...
${chalk.yellowBright(`
          ...
          if (userdata.money >= price) {
            if (item_cat === "weapons") {
              ...
              if (!heal.names.includes(name)) {
                ...
                let index: number = heal.names.indexOf(name);
                heal.number[index] += 1;
              }
              ...
              \n`)
                ...
                let index: number = magics.names.indexOf(name);
                magics.number[index] += 1;
              }
            }
          } else {
      ...
      if (items_category === "Weapons") {
        if (weapons === "Kasaka's Venom Fang Sowrd") {
          await want_to_purchase(
            "Kasaka's Venom Fang Sowrd",
            250,
            "This will increase attack damage upto 25",
            "weapons"
          );
          ...
          await want_to_purchase(
            "Knight Killer Sowrd",
            350,
            "This will increase attack damage upto 40",
            "weapons"
          );
          ...
          await want_to_purchase(
            "Baruka’s Daggers Sword",
            400,
            "This will increase attack damage upto 60",
            "weapons"
          );
          ...
          await want_to_purchase(
            "Demon King's Daggers Sowrd",
            470,
            "This will increase attack damage upto 80",
            "weapons"
          );
          ...
          await want_to_purchase(
            "Demon King's Longsword",
            540,
            "This will increase attack damage upto 100",
            "weapons"
          );
          ...
          await want_to_purchase(
            "Kamish's Wrath Sowrds",
            600,
            "This will increase attack damage upto 130",
            "weapons"
          );
      ...
      //---------------------------------------------------------
        ...
        if (armors === "Red Knight’s Helmet") {
          await want_to_purchase(
            "Red Knight’s Helmet",
            250,
            "This will increase health 20% and decrease oppenent damage 10%",
            "Armor"
          );
          ...
          await want_to_purchase(
            "High Magician’s Ring",
            280,
            "This will increase health 40% and decrease oppenent damage 5%",
            "Armor"
          );
          ...
          await want_to_purchase(
            "Gatekeeper's Necklace",
            280,
            "This will increase health 5% and decrease oppenent damage 15%",
            "Armor"
          );
          ...
          await want_to_purchase(
            "Red Knight’s Shield",
            250,
            "This will decrease oppenent damage 20%",
            "Armor"
          );
      ...
      //---------------------------------------------------------------
        ...
        if (magic === "Unicorn's Horn") {
          await want_to_purchase(
            "Unicorn's Horn",
            250,
            "This will reduce oppenent health 50%",
            "magic"
          );
          ...
          await want_to_purchase(
            "Mirror Image",
            280,
            "This will decrease oppnent attacking damage 50%",
            "magic"
          );
          ...
          await want_to_purchase(
            "Wrath of Zeus",
            350,
            "This will reduce oppenent health 100%",
            "magic"
          );
