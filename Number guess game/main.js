...
//game title
console.log(chalk.bold.underline.green(`Welcome to Number Guess Game:`) +
...
async function number_game() {
    ...
    async function questions() {
        console.log(chalk.bgBlueBright(`  ${user_data.username}  `) +
        ...
        else if (question.number === game_number_range &&
            Level.Level === "Normal") {
            console.log(chalk.greenBright(`\n
        ----------------------------------------------
        Congratulation you guess the right number!!
        ...
        else if ((question.number > 3 || question.number < 0) &&
            Level.Level === "Easy") {
        ...
        else if ((question.number > 6 || question.number < 0) &&
            Level.Level === "Normal") {
            console.log(chalk.red(`\n
        ----------------------------------------------
        ...
        else if ((question.number > 10 || question.number < 0) &&
            Level.Level === "Hard") {
            console.log(chalk.red(`\n
        ----------------------------------------------
